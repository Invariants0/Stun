...
module "iam" {
  ...
  backend_service_account_id    = "stun-backend-prod"
  frontend_service_account_id   = "stun-frontend-prod"
}
...
module "artifact_registry" {
  ...
  region        = var.region
  repository_id = "stun-prod"
  description   = "Container images for Stun production environment"
  labels        = local.labels
...
module "backend" {
  ...
  service_name          = "stun-backend-prod"
  location              = var.region
...
module "frontend" {
  ...
  service_name          = "stun-frontend-prod"
  location              = var.region
